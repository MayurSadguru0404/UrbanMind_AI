...
const s = {
  ...
  mobileOverlay:    { position: "fixed", top: 52, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", zIndex: 300 },
  mobilePanel:      { position: "fixed", top: 52, left: 0, right: 0, bottom: 0, background: "#111118", padding: "14px 14px", overflowY: "auto", zIndex: 400, display: "flex", flexDirection: "column", gap: 6 },
